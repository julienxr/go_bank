...
func TestTransferTx(t *testing.T) {
	...
	// fmt.Printf(">> Before Balances: Account1(%v), Account2(%v))\n", account1.Balance, account2.Balance)
	// run n concurrent transfer transactions to ensure TransferTx
	// upholds during concurrent calls
	...
	for i := 0; i < n; i++ {
		...
		// fmt.Printf(">> Transactions: Account1(%v), Account2(%v))\n", fromAccount.Balance, toAccount.Balance)
		...
		require.True(t, delta1%amount == 0) //1 * amount, 2*amount, 3*amount,..., n * amount
	...
	// fmt.Printf(">> After Balances: Account1(%v), Account2(%v))\n", updatedAccount1.Balance, updatedAccount2.Balance)
